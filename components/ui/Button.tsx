...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variants = {
    primary:   'bg-[#1a3a5c] text-white hover:bg-[#15304d] focus:ring-[#1a3a5c]',
    secondary: 'bg-[#c0392b] text-white hover:bg-[#a93226] focus:ring-[#c0392b]',
    danger:    'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500',
    ghost:     'text-[#1a3a5c] hover:bg-blue-50 focus:ring-[#2563EB]',
